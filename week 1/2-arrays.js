...
let carModels = [];
let carModelsSorted = [];
 carModelsSorted = inventory.sort((a, b)=>{
...
let oldCars = [];
oldCars = carYears.filter(function(year){
  return year  < 2000
})
console.log(oldCars);
...
let BMWAndAudi = [];
  BMWAndAudi = inventory.filter((n)=>{

  return n.car_make=="Audi"  ||  n.car_make ==="BMW";
})

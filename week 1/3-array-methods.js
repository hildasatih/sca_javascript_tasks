...
let fullNames = [];
runners.forEach(function(n){
  fullNames.push(n.first_name, n.last_name);
})
...
let  firstNamesAllCaps =[];
  firstNamesAllCaps = runners.map(function(n){
    return n.first_name.toUpperCase()
  })
...
// Problem 1
let scores = [50, 55, 90, 70, 20, 30, 45, 90, 78, 77]
...
// Problem 2
let teams =[
  {name:"faith", football:true},
  {name:"james", tennis:true},
  {name:"happy", football:false},
  {name:"lewis", football:true},
  {name:"john", tennis:true},
  {name:"hope", football:true}
]
  let footballTeam = teams.filter(function(team){
